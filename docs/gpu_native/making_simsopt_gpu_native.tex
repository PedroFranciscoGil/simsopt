...
makes a candidate ineligible.  This ordering prevents a faster but physically
invalid design from winning.  The reduced screen selects a candidate; it is
not itself evidence that the same ordering transfers to production scale.
