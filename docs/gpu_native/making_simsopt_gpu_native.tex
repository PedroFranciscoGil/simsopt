...
Retain per-workload autotuning and prioritize the deferred distance and
curvature terms so the complete production objective can be measured.  If that
profile remains below target, prototype a fused, tail-aware Pallas/Triton
kernel while preserving the present JAX implementation as the reference.
