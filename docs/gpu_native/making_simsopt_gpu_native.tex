...
have been swept.  With transfer and launch overhead greatly reduced, the next
implementation experiment is a fused or custom Biot--Savart VJP.  The
production-size test and tuned CPU baseline remain necessary before evaluating
the $3\times$ speed gate.
