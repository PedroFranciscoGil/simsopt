...
batching remains a low-risk later optimization; the next milestone is an
end-to-end SciPy L-BFGS-B trajectory comparison using this complete executable.
...
sequence is now: exercise the SciPy bridge in an end-to-end trajectory
comparison; specialize a measured bottleneck only if needed; then evaluate
native L-BFGS and matrix-free least-squares solvers.
