...
interpret this capped run as a stationary solution.  Before comparing native
solvers, extend the convergence experiment and address variable scaling,
especially the raw $10^5$-ampere current coordinates used by the intermediate
example.  Solver conclusions must use converged engineering metrics and report
compile-amortized as well as warm-start time.
\endgroup
