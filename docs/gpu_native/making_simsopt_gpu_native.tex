...
The matched-bound archive from revision \code{ca748727} has SHA-256
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.98\textwidth]{figures/end_to_end_al_performance.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.98\textwidth]{figures/end_to_end_al_convergence.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\textwidth]{figures/end_to_end_al_final_metrics.png}
