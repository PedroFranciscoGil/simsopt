...
independent NumPy oracle.  Eighteen focused tests and all 103 GPU-module tests
...
\textbf{Decision.}  Keep the original aggregate constraints for backward
compatibility, but make this local residual vector the required boundary for the
next safeguarded optimization experiment.  Do not run that experiment until an
NVIDIA archive passes all residual value and directional-Jacobian gates.  Exact
symmetry points remain valid for value tests; a deterministic off-symmetry probe
is required only when claiming a classical Jacobian comparison.
